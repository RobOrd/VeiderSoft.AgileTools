...
namespace Project.Client.SHAGenerator.Models.Home
{
    public class StartViewModel : ViewModel
    {
        ...
        public void LoadActions()
        {
            ...
            Actions.Add(new ViewAction("Resources Visualizer", category: "Tools", execute: (a, o) => Controller.Action("Home", "ResourceVisualizer"), brushResourceKey: "CODE.Framework-Icon-Comment"));
