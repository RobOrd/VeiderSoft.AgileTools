...
namespace BlockCodeGen
{
    class Program
    {
        const string _readPrompt = "bcg> ";
        const string _commandNamespace = "BlockCodeGen.Commands";
        ...
        public static void Main(string[] args)
        {
            ...
            foreach (var commandClass in commandClasses)
            {
                ...
                foreach (var method in methods)
                {
                    ...
                    methodDictionary.Add($"{commandName}|{parameters.Count()}", parameters);
                }
        ...
        private static string Execute(ConsoleCommand command)
        {
            ...
            var commandName = $"{command.Name}|{command.Arguments.Count()}";
            if (!methodDictionary.ContainsKey(commandName))
            {
                return badCommandMessage;
            }
            ...
            IEnumerable<ParameterInfo> paramInfoList = methodDictionary[commandName].ToList();
